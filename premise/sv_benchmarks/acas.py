...
BEARING_COARSE = 10  # old 121
BEARING_STD = np.deg2rad(1.0027)  # radians

REL_HEADING_MIN = -math.pi  # radians
REL_HEADING_MAX = math.pi  # radians
REL_HEADING_COARSE = 10  # old 121
REL_HEADING_STD = np.deg2rad(1.0027)  # radians

EGO_SPEED_MIN = 15  # m/s
EGO_SPEED_MAX = 75  # m/s
EGO_SPEED_COARSE = 5  # old 94
EGO_SPEED_STD = 0.5  # m/s

INT_SPEED_MIN = 0  # m/s
INT_SPEED_MAX = 75  # m/s
INT_SPEED_COARSE = 5  # old 4
INT_SPEED_STD = 1.1  # m/s
...
class ACAState(pgc.State):
    ...
    def __init__(
        self,
        radius: CoarseValue = None,
        bearing: CoarseGaussianValue = None,
        rel_heading: CoarseGaussianValue = None,
        ego_speed: CoarseGaussianValue = None,
        int_speed: CoarseGaussianValue = None,
        ...
        if radius is None:
            self.radius = CoarseValue(radius_min, radius_max, radius_coarse)
        else:
            self.radius = radius
