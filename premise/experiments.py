...
configurations = [  # monitoring.UnfoldingOptions(environment, exact_arithmetic=True),
    monitoring.UnfoldingOptions(
        environment, exact_arithmetic=True, custom_str="unfrefactored"
    )
]
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--trace-length", default=100, type=int, help="How long should the traces be?"
    )
    parser.add_argument(
        "--promptness-deadline",
        default=1000,
        ...
        for config in configurations:
            ...
            try:
                monitoring.run_monitor(
                    ...
                    promptness_deadline=promtness_deadline,
                    simulator_seed=range(nr_traces),
