...
// Model parameters
const double PF = 0.8;  // forwarding probability
const double badC = 0.2;  // probability that member is untrustworthy
...
const int CrowdSize = 13; // CWDSIZ: actual number of good crowd members
...
module crowds
	...
	[] recordLast & CrowdSize=13 ->
	        1/13 : (lastSeen'=0)  & (recordLast'=false) & (run'=true) +
	        1/13 : (lastSeen'=1)  & (recordLast'=false) & (run'=true) +
	        1/13 : (lastSeen'=2)  & (recordLast'=false) & (run'=true) +
	        1/13 : (lastSeen'=3)  & (recordLast'=false) & (run'=true) +
	        1/13 : (lastSeen'=4)  & (recordLast'=false) & (run'=true) +
	        1/13 : (lastSeen'=5)  & (recordLast'=false) & (run'=true) +
	        1/13 : (lastSeen'=6)  & (recordLast'=false) & (run'=true) +
	        1/13 : (lastSeen'=7)  & (recordLast'=false) & (run'=true) +
	        1/13 : (lastSeen'=8)  & (recordLast'=false) & (run'=true) +
	        1/13 : (lastSeen'=9)  & (recordLast'=false) & (run'=true) +
	        1/13 : (lastSeen'=10) & (recordLast'=false) & (run'=true) +
	        1/13 : (lastSeen'=11) & (recordLast'=false) & (run'=true) +
	        1/13 : (lastSeen'=12) & (recordLast'=false) & (run'=true);
	[] recordLast & CrowdSize=14 ->
	        1/14 : (lastSeen'=0)  & (recordLast'=false) & (run'=true) +
	        1/14 : (lastSeen'=1)  & (recordLast'=false) & (run'=true) +
	        1/14 : (lastSeen'=2)  & (recordLast'=false) & (run'=true) +
	        1/14 : (lastSeen'=3)  & (recordLast'=false) & (run'=true) +
	        1/14 : (lastSeen'=4)  & (recordLast'=false) & (run'=true) +
	        1/14 : (lastSeen'=5)  & (recordLast'=false) & (run'=true) +
	        1/14 : (lastSeen'=6)  & (recordLast'=false) & (run'=true) +
	        1/14 : (lastSeen'=7)  & (recordLast'=false) & (run'=true) +
	        1/14 : (lastSeen'=8)  & (recordLast'=false) & (run'=true) +
	        1/14 : (lastSeen'=9)  & (recordLast'=false) & (run'=true) +
	        1/14 : (lastSeen'=10) & (recordLast'=false) & (run'=true) +
	        1/14 : (lastSeen'=11) & (recordLast'=false) & (run'=true) +
	        1/14 : (lastSeen'=12) & (recordLast'=false) & (run'=true) +
	        1/14 : (lastSeen'=13) & (recordLast'=false) & (run'=true);
