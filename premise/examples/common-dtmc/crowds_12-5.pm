...
const int CrowdSize = 12; // CWDSIZ: actual number of good crowd members
...
module crowds
	...
	[] recordLast & CrowdSize=12 ->
	        1/12 : (lastSeen'=0) & (recordLast'=false) & (run'=true) +
	        1/12 : (lastSeen'=1) & (recordLast'=false) & (run'=true) +
	        1/12 : (lastSeen'=2) & (recordLast'=false) & (run'=true) +
	        1/12 : (lastSeen'=3) & (recordLast'=false) & (run'=true) +
	        1/12 : (lastSeen'=4) & (recordLast'=false) & (run'=true) +
	        1/12 : (lastSeen'=5) & (recordLast'=false) & (run'=true) +
	        1/12 : (lastSeen'=6) & (recordLast'=false) & (run'=true) +
	        1/12 : (lastSeen'=7) & (recordLast'=false) & (run'=true) +
	        1/12 : (lastSeen'=8) & (recordLast'=false) & (run'=true) +
	        1/12 : (lastSeen'=9) & (recordLast'=false) & (run'=true) +
	        1/12 : (lastSeen'=10) & (recordLast'=false) & (run'=true) +
	        1/12 : (lastSeen'=11) & (recordLast'=false) & (run'=true);
