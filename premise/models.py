...
default_models = {
    ...
    "grid-line-5": ModelDescription(
        Path(__file__).parent / "examples/grid-line/grid-line.nm",
        "N=5",
        'Pmax=? [F<=5 "crash"]',
        target_label="crash",
        horizon=5,
    ...
    "grid-walls-5": ModelDescription(
        Path(__file__).parent / "examples/grid-line/grid-walls.nm",
        "N=5",
        'Pmax=? [F<=5 "crash"]',
        target_label="crash",
        horizon=5,
    ...
    "grid-walls-20": ModelDescription(
        Path(__file__).parent / "examples/grid-line/grid-walls.nm",
        "N=20",
        'Pmax=? [F<=5 "crash"]',
        target_label="crash",
