...
def learn_conformal_precition_model(args, model, suo, dataset, initial_amount, horizon):
    ...
    if args.do_refinement:
        ...
        unc_meas_ref, unc_states_ref, unc_outputs_ref = utils.Comb_PONSC_active_sample_query(suo, ref_samples, (initial_amount + horizon), horizon, model_class=model, conf_pred = cp_comb_class, trained_svc = query_fnc, se_fnc = se_fnc, dataset=dataset)
    ...
    return  active_comb_ponsc, active_query_fnc, active_cp_comb_class, n_ref_points, n_active_points
